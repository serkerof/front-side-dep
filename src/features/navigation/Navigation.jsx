...
const Navigation = ({
            ...
            <li key={link.id}>
                ...
                >
                    ...
                    <span className={`${styles.padding_right_icon}`}>
                        <GoTriangleRight
                            className={`${styles.vertical_middle} tablet-display-none `}
                        />
                    </span>
                    {link.hasSubmenu && (
    ...
    return (
        <div
            className={`mobile-padding tablet-md-padding normalize-padding navigation-height d-flex align-center justify-between ${
        ...
        >
            ...
            <div className="d-flex">
                ...
                />
                <ul className="mobile-display-none d-flex navigation-container">
                    {renderedLinks}
                </ul>
            </div>
