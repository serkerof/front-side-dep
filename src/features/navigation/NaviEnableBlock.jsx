...
const NaviEnableBlock = ({ mr_nv_btn, mr_nv_nv }) => {
    ...
    return (
        <div className="d-flex">
            <DefaultButton
                classData={`mobile-display-none tablet-display-none button-detailed button-detailed-transparent ${mr_nv_btn}`}
                contentData="Daxil ol"
                handleNavigation={handleSignUp}
            />
            <DefaultButton
                classData={`mobile-display-none tablet-display-none button-detailed button-detailed-white ${mr_nv_nv}`}
